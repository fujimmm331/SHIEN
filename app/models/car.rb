class Car < ApplicationRecord
  ...
  validates :class_number, :registration_number, :vhicle_inspection_day, :registered_year, numericality: { only_integer: true }, message: "は半角数字のみ使用できます"
  ...
  validates :vhicle_inspection_day, :registered_year, length:{ maximum: 12 }, messages: "は12文字以内で入力してください"
end
