...
100.times do |i|
  ...
  Matter.create(name:"株式会社サンプル#{i + 1}", sales_person: sales_name, kana_sales_person: kana_sales_name, email: email, phone_number:phone_number, cell_phone_number:cell_phone_number, postal_code:"1000001", municipality: municipality, address:"1-1-1", building:"サンプルビル1F", user_id:3, team_id:1)
end
...
100.times do |i|
  ...
  Matter.create(name:"有限会社サンプル#{i + 1}", sales_person: sales_name, kana_sales_person: kana_sales_name, email: email, phone_number:phone_number, cell_phone_number:cell_phone_number, postal_code:"1000001", municipality: municipality, address:"1-1-1", building:"サンプルビル1F", user_id:4, team_id:1)
end